...
DEFAULT_ADAPTER_DIR = (
    ROOT / "data" / "qwen_zh_short_sft" / "adapters" / "qwen2.5-0.5b-short-sft-lora"
)
...
def parse_args() -> argparse.Namespace:
    parser = argparse.ArgumentParser(
        description="加载 Qwen2.5-0.5B + 中文短答案 LoRA adapter 做推理。"
    )
...
def main() -> None:
    ...
    messages = [
        {
            "role": "system",
            "content": "你是一个有帮助的中文助手。除非用户要求详细解释，否则优先简短回答。",
        },
    ...
    print("mode=qwen_zh_short_sft_lora_inference")
