...
DEFAULT_DATA_PATH = ROOT / "data" / "qwen_zh_sft" / "raw" / "alpaca_zh_5000.jsonl"
DEFAULT_OUTPUT_DIR = ROOT / "data" / "qwen_zh_sft" / "adapters" / "qwen2.5-0.5b-alpaca-zh-lora"
...
def parse_args() -> TrainConfig:
    parser = argparse.ArgumentParser(description="在本地 Qwen2.5-0.5B 上用中文单轮 SFT 数据做 LoRA 微调。")
    ...
    parser.add_argument("--max-updates", type=int, default=120)
